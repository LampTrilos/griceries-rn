    ...
    reducers: {
        addItem: (state, action) => {
            ...
            if (!itemExists) {
                ...
                axiosPost('recipeList', action.payload)
            }
        },
        editItem: (state, action) => {
            ...
            //console.log(state.value)
            axiosPut('recipeList', action.payload)
            state.value = reOrderList(state.value)
        },
        removeItem: (state, action) => {
            ...
            //console.log(state.value)
            axiosDelete('recipeList', action.payload)
            state.value = reOrderList(state.value)
        },
...
export const { addItem, editItem,  removeItem, setItems } = recipeListSlice.actions
